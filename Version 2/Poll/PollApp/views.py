...
def create_poll(request):
    ...
    if request.method =="POST":
        ...
        obj1 = PollQuestion(created_by=created_by,poll_name = poll_name,que_text=poll_que,que_image=poll_image,anonymous=anonymous)
        obj1.save() 
...
def poll_result(request):
    if request.method=="POST":
        ...
        # print(que)
        return render(request,"result.html",{"que":que,"choice":choice})
